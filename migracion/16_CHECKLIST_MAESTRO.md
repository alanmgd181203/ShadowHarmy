...
- [~] **4.0.4** Cablear Beru en `arise` tras manto logrado (`pase_director.beru_puede_cazar`)
  - **Beru rango lineal (2026-08-20):** oficio nuevo · laterales · Vacío 1,2 **arma trailing** · Oz trailing 0,2 · sangre 1,2 / Red→$5 · un vivo · manos OFF · [`22_DOCTRINA_BERU_RANGO.md`](22_DOCTRINA_BERU_RANGO.md) · smoke `validar_beru_rango_smoke.py` · teatro `teatro_beru_rango.py` ✅ frío
