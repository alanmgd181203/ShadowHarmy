...
- **Beru rango lineal (2026-08-20):** Vacío/sangre = **activación 1,2** · Oz = **callback trailing 0,2** · Red = **trailing** (act. **0,7** + callback 0,2 · $5) · sangre cancela Red · un vivo · manos OFF · [`22_DOCTRINA_BERU_RANGO.md`](22_DOCTRINA_BERU_RANGO.md) · smokes + teatro HYPE
