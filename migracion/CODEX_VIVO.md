...
- **Caja USDT (mega-cirugía 2026-08-12):** Tusk para en USDT · no compra MNT · no short de equilibrio · potencia pase = caja · MNT = Santo
- **Beru rango lineal (2026-08-20):** oficio **nuevo** · Vacío ±1,2 **arma trailing** · Oz = **trailing 0,2** (SHORT al bajar / LONG al subir) · tras Oz: sangre **1,2** ($10) **o** Red 0,7 → Beru **$5** · ladder repetible · un vivo · manos OFF (Stop+amend en Bybit cuando ON) · doctrina [`22_DOCTRINA_BERU_RANGO.md`](22_DOCTRINA_BERU_RANGO.md) · smoke `validar_beru_rango_smoke.py` · teatro `teatro_beru_rango.py`
- **Beru Vacío 1,1 desde wake (cirugía 2026-08-17):** un oficio · primer silbato Vacío ±1,1 / Hoz 1,0 desde el precio de wake, puntos del metro del manto · Mariscal nace con 10×G_min ($50 si G_min=$5) · relevo 0,9/0,5/0,3 (Mariscal 0,1) desde última Red · los cuatro grados dejan hijo · tumor «esperar ±0,9 del manto» extirpado · negociador/ping-pong/residual/capas/fusión/Mega extirpados · manos OFF · doctrina [`22_DOCTRINA_BERU.md`](22_DOCTRINA_BERU.md)
- **Beru Hoz de venta cruzada (2026-08-19):** last ya bajo la Hoz SHORT y Stop sin fill → cancela y ráfaga (no espera el subidón) · sello duplicado 170141 nace otro · pose sana: Hoz abajo, Red arriba
- **Beru tres cortes (2026-08-19):** masa chica si Tusk ahogada · pulso paralelo (cupo 8; `10006` = cooldown de ese Santo) · mismo sello al reintentar (`170213` no enreda; `170141` sí nace otro) · smokes frío · manos OFF · no arise
- **Beru mini (2026-08-19):** no segunda planta si el altar ya vuela · Tusk suelta oxígeno si la Hoz no nació
- **Teatro ráfaga pulso (2026-08-19):** casa falsa · mínima+fill e hijo · radar al tocar Oz · mecha no cosecha Stop viva · ráfaga incompleta espera · frase de ahogo vence código nuevo
- **Beru un oído (2026-08-19):** acecho y caza beben el mismo latido (tratos, alto y bajo) · engorde persigue el extremo en el pulso · la Hoz en vivo solo cierra con fill de casa
- **Beru lecturas cosecha + sin manto fuera (2026-08-19):** cada fill anota metro (vs manto) y Hoz (vs última Oz) · tierra sin metro no se siembra ni ensucia ojos Beru (casa ticker puede quedar) · flota Pergamino: cazando → acecho por % al oído · cache `v20`
...
- **Igris DE BAJA (2026-08-20, rama `beru-bby`):** manto dual fuera del norte. Quedan Tank · Tusk · Kaiser (Greed + lineal) · Greed · Beru (protagonista; Monarca reescribe en `master`). Sin `OPORTUNIDAD_MANTO` ni frecuencia de espejo.
- **Purga campamento (2026-08-20):** fuera checkpoints/informes/coliseo/teatros/fuentes crudas · fósiles Beru (negociador/fusión/Mega/residual) y sus smokes borrados · sin archivar · puerta Jess = solo `ORDEN_ACTIVA_JESS`
...
- **Bóveda MNT (LEGADO):** ritual MNT+short+fees **extirpado** · caja USDT
- **Kaiser índice+sesgo:** índice absoluto · digest `sesgo_estructural` · backfill mares
...
- **Manto vs cero estructural (2026-08-02):** frecuencia/ETA + puerta Igris cuentan **exceso vs cero** (no gap eterno) · `MANTO_CERO_ESTRUCTURAL` · informe `scripts/informe_sesgo_monarca.py` · (purgado)
...
- **Teatro de sombras Igris (lab, 2026-08-04→06):** 1 óptica + **2** marchas de papel (asalto · personalizado) · preparado, no soltado · no es 4.0.3 · `TEATRO_SOMBRAS_IGRIS.md`
- **Oído Bellion 4.1.2 (2026-07-24):** tabla evento→nivel · `bellion_oido` · portal Cascada · sin LLM/Telegram
- **Pergamino React (local + celular):** Cascada → Manto Igris · Beru Sub-Santuario (flota por calor · botón Santos por rango · sin huecos ni 00 · tarjetita grado/saco/cazas · velas + rayas; 0 local = wake de esta vida · dual Vacío **solo semilla** · luego sangre contraria a la Hoz · Hoz/Red · hijo $G_min · chip saco = masa del Vacío ahora (acecho) o Hoz viva (caza) · lienzo clava encuadre (no replanta el campo) · × solo desde este arise; Hoz amarilla · Red azul · masa a la izquierda) · **Bellion susurro + foto viva completa** · Tusk/Tank/Greed dump crudo · Ascensión Tusk · **túnel PWA** `iniciar_panel_pwa` (HTTPS, sin matar Beru) · sello cache `v20`
...
- **Pase batalla 13 Santos:** histórico (purga 2026-08-20; superado por pase 17)
- **Candado rango (2026-07-19):** `MONARCA_RANK_GATE` → Igris auditoría/despliegue + Beru casa (no live) + Ascensión viva desde `estado_vivo`
- **Director pase (2026-07-19→08-06):** `pase_director` — potencia/lote · **2 marchas operativas (asalto · personalizado)** · **fill 100% · reserva 1** · personalizado por T · legado táctico/forzada → asalto · altar hidrata JSON · `set_marcha_cli` · sello (purgado)
- **Ley Igris≠Greed · Asalto (2026-08-06):** Igris peaje aceptado / plantar; caza edge = Greed después; indicadores/peinado Kaiser después; orden Igris→Beru→Greed · (purgado) · doctrina `21`
...
- **Lotes Bybit qtyStep (2026-07-20):** `core/lote_bybit.py` lee BD Jess · peldaños/órdenes en múltiplos reales · (purgado)
...
- **Panel cableado (2026-08-06):** estado_vivo → marcha · ventana 48–52 · meta engorde · ley_masa lectura · Tusk O₂/equity; Jess corre 4.0.3 Asalto · USA no ejecuta · (purgado)
- **Noche historial flota Igris (2026-08-06):** bóveda velas 1m spot+L+S de la flota manto · función ejército · **≠ 4.0.3** · (purgado) 
- **Jess runbook informe:** `JESS_INFORME_SESGO.md`
...
- **Igris sim 4.0.2:** (purgado) · manos atadas / ilusorias
